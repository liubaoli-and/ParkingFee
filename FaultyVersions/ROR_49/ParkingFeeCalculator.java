...
package com.lwf.ustb.www.FEE.mutant.ROR_49;
...
public class ParkingFeeCalculator
{
    ...
    private  double parkingFeeWithoutDiscount( int typeOfVehicle, int typeOfCar, int dayOfWeek, double apd )
    {
        ...
        if (typeOfVehicle == com.lwf.ustb.www.FEE.util.Vehicle.CAR && typeOfCar != com.lwf.ustb.www.FEE.util.Car.TWO_DOOR_COUPE && false) {
            return -1;
        }
