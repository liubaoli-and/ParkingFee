...
package com.lwf.ustb.www.FEE.mutant.ROR_34;
...
public class ParkingFeeCalculator
{
    ...
    private  double parkingFeeWithoutDiscount( int typeOfVehicle, int typeOfCar, int dayOfWeek, double apd )
    {
        ...
        if (true && typeOfCar != com.lwf.ustb.www.FEE.util.Car.TWO_DOOR_COUPE && typeOfCar != com.lwf.ustb.www.FEE.util.Car.OTHERS) {
            return -1;
        }
