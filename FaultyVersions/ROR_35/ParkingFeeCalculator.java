...
package com.lwf.ustb.www.FEE.mutant.ROR_35;
...
public class ParkingFeeCalculator
{
    ...
    private  double parkingFeeWithoutDiscount( int typeOfVehicle, int typeOfCar, int dayOfWeek, double apd )
    {
        ...
        if (false && typeOfCar != com.lwf.ustb.www.FEE.util.Car.TWO_DOOR_COUPE && typeOfCar != com.lwf.ustb.www.FEE.util.Car.OTHERS) {
            return -1;
        }
