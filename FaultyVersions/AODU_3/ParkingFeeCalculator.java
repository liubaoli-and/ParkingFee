...
package com.lwf.ustb.www.FEE.mutant.AODU_3;
...
{static public void main(String args[]){
	ParkingFeeCalculator f=new ParkingFeeCalculator();
	System.out.println(f.parkingFee(1, 1,1, 1, false, "(0, 2]"));
	System.out.println(f.parkingFee(1, 1,1, 2, false, "(0, 2]"));
}
